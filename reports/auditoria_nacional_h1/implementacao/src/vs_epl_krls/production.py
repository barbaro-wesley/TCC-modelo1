...
class S10ProductionForecaster:
    ...
    def fit_calibrated(
        ...
        **kwargs,
        ...
        """Shared initialization for deployment and development replay.

        Callers must supply out-of-sample residuals preceding the forecast origin.
        No model choice or evaluation labels are consumed by this constructor.
        """
        bundle = cls(candidate, **kwargs).fit(history)
        bundle.warm_start_interval_alpha()
        return bundle
